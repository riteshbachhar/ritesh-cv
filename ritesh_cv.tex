...
\section{Research Interests}
  \begin{onecolentry}
    General relativity~(GR), Surrogate modeling of gravitational waves, Gravitational wave parameter estimation, Black hole merger phenomenology, Point-particle black hole perturbation theory
  \end{onecolentry}
...
\begin{onecolentry}
  \begin{highlightsforbulletentries}
    ...
    \item \textbf{CSIR NET} (June 2019) -– Achieved All India Rank \textbf{66}, qualifying for Junior Research Fellowship (JRF) in Physical Sciences.
...
\begin{twocolentry}{September 2021 - Present}{\textbf{Surrogate modeling of gravitational waves}}
    \begin{highlights}
        ...
        \item Modeling the gravitational waveforms of intermediate mass ratio inspirals (IMRIs)
    \end{highlights}
\end{twocolentry}
...
\begin{twocolentry}{July 2023 - Present}{\textbf{Systematics in gravitational wave modeling}}
    \begin{highlights}
        \item Studied the impact of waveform calibration errors on gravitational wave parameter estimation
        \item Incorporated the waveform calibration error in the gravitational wave modeling in the context of \texttt{SEOBNRv4}, a class of effective-one-body models
        \item Performed parameter estimation studies using simulated data to quantify the impact of waveform calibration errors
    \end{highlights}
\end{twocolentry}
...
\begin{twocolentry}{July 2019 - January 2022}{\textbf{Timing and spectral analysis of X-ray pulsar: Centaurus X-3}}
    \begin{highlights}
        \item Studied the process of X-ray emission of HMXBs, particularly for Cen X-3
